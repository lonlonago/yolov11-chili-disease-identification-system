# YOLOv11 Chili Disease Identification System

## Body

The pepper disease detection system based on deep learning YOLOv11 is a pepper leaf disease detection system (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model).

nc:5 classes, 
Names: ['xanthomonas', 'mosaic', 'healthy', 'cercospora', 'leaf curl'], 
Number of datasets: 1796 training set, 462 validation set.
